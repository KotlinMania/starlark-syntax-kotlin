# Agent guide - starlark-syntax-kotlin

This file is the quick-reference operating contract for starlark-syntax-kotlin. The longer
...
starlark-syntax-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`starlark-syntax`](./README.md). Upstream Rust is the behavioral oracle while the
