...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `StarlarkSyntax.swiftmodule/`
...
//      `import StarlarkSyntax` above would fail at compile time.
//
//   2. The static archive `libStarlarkSyntax.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "StarlarkSyntax" }` and
//      `flattenPackage = "io.github.kotlinmania.starlarksyntax"` configuration in
...
//      via the `StarlarkSyntaxLibrary` product.
//
...
final class StarlarkSyntaxExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "StarlarkSyntax swift module imported cleanly")
    }
}
